...
const NAV_ITEMS = [
  ...
  { key: "assets", label: "Asset Management", href: "/assets", icon: IconAsset },
  { key: "leave", label: "My Leave", href: "/leave", icon: IconLeave },
  { key: "attendance", label: "My Attendance", href: "/attendance", icon: IconAttendance },
] as const;
...
export default function AppShell({
  ...
  active: "today" | "history" | "reports" | "assets" | "leave" | "attendance";
  title: string;
  subtitle?: string;
